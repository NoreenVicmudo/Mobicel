...
<html>
	<head>
		<link rel="stylesheet" href="edit_prod_stor.css"/>
					...
					<hr class = "register-line">
						<form method="POST" id="register-form" target="_self">
							<div class="input-group">									
								<input type="text" name="storID" placeholder="Storage ID">
							</div>	
							<div class="input-group">									
								<input type="number" name="editPrice" placeholder="Update Price">
							</div>	
							<div class="input-group">									
								<input type="number" name="editStocks" placeholder="Update Stocks">
							</div>						
