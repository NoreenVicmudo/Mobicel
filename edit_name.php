...
<html>
	...
	<body>
			...
			<div class="container">
				<div id="glass">
					<h1 class="headline"> Change Name </h1>
					<hr class = "register-line">
					<form method="POST" id="register-form" target="_self">
						<div class="input-group">									
							<input type="text" name="change_fname" placeholder="First Name">
						</div>	
						<div class="input-group">									
							<input type="text" name="change_lname" placeholder="Last Name">
						</div>	
						<p> Type password to verify: </p>
						<div class = "input-group">
