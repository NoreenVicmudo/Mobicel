...
<html>
<head>
    <link rel="stylesheet" href="prod_li_tbl.css"/>
    ...
    <div class="container">
        <div class="bg-color">
            ...
            <div class="search-form">
                <input type="submit" value="+ Product" class="add-category-btn">
            </div>
            <div class="table-container">
                <table>
                    ...
                    <tr>
						...
						<td> placeholder </td>
						<td> placeholder </td>
						<td> <center> <a href = "edit_product_list.php"> Edit </center> </td>
						<td> <center> <a href = "delete_prod.php"> Delete </center> </td> 
                    </tr>
                </table>
            </div>
        </div>
