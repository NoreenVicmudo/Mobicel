...
<html>
	<head>
		<link rel="stylesheet" href="edit_color.css"/>
	...
	<body>
			...
			<div class="container">
				<div id="glass">
					<h1 class="headline"> Edit Color </h1>
					<hr class = "register-line">
						<form method="POST" id="register-form" target="_self">
							<div class="input-group">									
								<input type="text" name="colorID" placeholder="Color ID">
							</div>	
							<div class="input-group">									
								<input type="number" name="assignColor" placeholder="Color">
							</div>						
